...
int main(int argc, char **argv)
{
  ...
  // Collecting file input// Michael Said
// Liam May
// COP 3402
// Spring 2020
...
void toInstruction(char *str)
{
  ...
  while (token != NULL)
  {
    if (i % 4 == 0)
    {
      // getting every first value in op field 
    }
  }
}
